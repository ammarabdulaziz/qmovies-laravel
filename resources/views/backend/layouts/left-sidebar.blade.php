    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/theatres" class="waves-effect">
                        <i class='bx bx-tv'></i><span>Theatres</span>
                    </a>
                </li>

                <li>
                    <a href="/movies" class="waves-effect">
                        <i class='bx bx-movie' ></i><span>Movies</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="/bookings" class="waves-effect">
                        <i class='bx bx-bookmark-plus'></i><span>Bookings</span>
                    </a>
                </li>
                {{-- <li>
