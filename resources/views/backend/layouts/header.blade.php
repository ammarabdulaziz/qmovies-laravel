            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="/assets/backend/images/small.png" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="/assets/backend/images/large.png" alt="" height="27">
                        </span>
                    </a>
                    ...
                    <a href="index.html" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="/assets/backend/images/large.png" alt="" height="30">
                        </span>
                    </a>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div>
                                            <img src="/assets/backend/images/megamenu-img.png" alt=""
            ...
            <div class="d-flex">
                ...
                {{-- <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" data-toggle="dropdown"
                        ...
                        <img class="" src="/assets/backend/images/flags/us.jpg" alt="Header Language" height="16">
                    </button>
                    <div class="dropdown-menu dropdown-menu-right">

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="/assets/backend/images/flags/spain.jpg" alt="user-image" class="mr-1" height="12">
                            <span class="align-middle">Spanish</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="/assets/backend/images/flags/germany.jpg" alt="user-image" class="mr-1"
                                height="12">
                        ...
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="/assets/backend/images/flags/italy.jpg" alt="user-image" class="mr-1" height="12">
                            <span class="align-middle">Italian</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="/assets/backend/images/flags/russia.jpg" alt="user-image" class="mr-1" height="12">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                        ...
                        <div data-simplebar style="max-height: 230px;">
                            ...
                            <a href="" class="text-reset notification-item">
                                <div class="media">
                                    <img src="/assets/backend/images/users/avatar-4.jpg"
                                        class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                    <div class="media-body">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        <img class="rounded-circle header-profile-user p-2" src="/assets/backend/images/users/user.png"
                            alt="Header Avatar">
