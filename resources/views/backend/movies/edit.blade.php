                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/movies/{{ $movie->movie_id }}" method="post" class="custom-validation">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        placeholder="Enter movie name" value="{{ $movie->name }}">
                                    @error('name')
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="rating"
                                            ...
                                            placeholder="Enter movie rating" value="{{ $movie->rating }}">
                                        @error('rating')
                                            <small class="text-danger pt-1">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="journer"
                                            ...
                                            placeholder="Enter movie journer" value="{{ $movie->journer }}">
                                        @error('journer')
                                            <small class="text-danger pt-1">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="duration"
                                            ...
                                            placeholder="Enter movie duration" value="{{ $movie->duration }}">
                                        @error('duration')
                                            <small class="text-danger pt-1">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('description') parsley-error @enderror"
                                            name="description" rows="5">{{ $movie->description }}</textarea>
                                        @error('description')
                                            <small class="text-danger pt-1">{{ $message }}</small>
                                        @enderror
                                    </div>
