                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/screens/{{ $screen->screen_id }}" method="post" class="custom-validation">
                                @csrf
                                {{ method_field('PUT') }}
                                <input type="hidden" name="theatre_id" value="{{ $screen->theatre_id }}">
                                <div class="form-group">
                                    <label>Name :</label>
                                    <input type="text" name="name"
                                        class="form-control @error('name') parsley-error @enderror"
                                        placeholder="Enter screen name" value="{{ $screen->name }}">
                                    @error('name')
                                        <small class="text-danger pt-1">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="row">
                                    <input type="hidden" name="mez_seating_id"
                                        value="{{ $screen->screenSeatings[0]->seating_id }}">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="mezzanine_capacity"
                                                ...
                                                placeholder="Enter mezzanine capacity"
                                                value="{{ $screen->screenSeatings[0]->capacity }}">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="mezzanine_price"
                                                ...
                                                placeholder="Enter mezzanine price"
                                                value="{{ $screen->screenSeatings[0]->price }}">
                                ...
                                <div class="row">
                                    <input type="hidden" name="balc_seating_id"
                                        value="{{ $screen->screenSeatings[1]->seating_id }}">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="balcony_capacity"
                                                ...
                                                placeholder="Enter balcony capacity"
                                                value="{{ $screen->screenSeatings[1]->capacity }}">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="balcony_price"
                                                ...
                                                value="{{ $screen->screenSeatings[1]->price }}">
                                            @error('balcony_price')
                                                <small class="text-danger pt-1">{{ $message }}</small>
                                            @enderror
                                        </div>
